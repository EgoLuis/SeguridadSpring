...
public class SeguridadAppConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		.withUser(usuarios.username("Luis").password("123").roles("usuario","ayudante","administrador"))
		...
		.withUser(usuarios.username("Laura").password("321").roles("usuario","ayudante","administrador"));
